...
const CLASS_ID = Components.ID("98d1aebb-2e53-4e9a-be5d-f9d696bde709"); // ← Change this
const CLASS_NAME = "SASS AutoComplete";
const CONTRACT_ID = "@mozilla.org/autocomplete/search;1?name=sass-autocomplete";
