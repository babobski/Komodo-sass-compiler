...
(function() {
	...
	this._selectIncludeFolder = function(node) {
		...
		var d = ko.views.manager.currentView.document || ko.views.manager.currentView.koDoc,
			...
			base = (file) ? file.baseName : null,
			path = (file) ? file.URI : null,
			includeSass01Folder01 = pref.getCharPref('includeSass01Folder01').length > 0 ? pref.getCharPref('includeSass01Folder01') : null,
			includeSass01Folder02 = pref.getCharPref('includeSass01Folder02').length > 0 ? pref.getCharPref('includeSass01Folder02') : null,
			includeSass01Folder03 = pref.getCharPref('includeSass01Folder03').length > 0 ? pref.getCharPref('includeSass01Folder03') : null,
			includeSass02Folder01 = pref.getCharPref('includeSass02Folder01').length > 0 ? pref.getCharPref('includeSass02Folder01') : null,
			includeSass02Folder02 = pref.getCharPref('includeSass02Folder02').length > 0 ? pref.getCharPref('includeSass02Folder02') : null,
			includeSass02Folder03 = pref.getCharPref('includeSass02Folder03').length > 0 ? pref.getCharPref('includeSass02Folder03') : null,
			includeSass03Folder01 = pref.getCharPref('includeSass03Folder01').length > 0 ? pref.getCharPref('includeSass03Folder01') : null,
			includeSass03Folder02 = pref.getCharPref('includeSass03Folder02').length > 0 ? pref.getCharPref('includeSass03Folder02') : null,
			includeSass03Folder03 = pref.getCharPref('includeSass03Folder03').length > 0 ? pref.getCharPref('includeSass03Folder03') : null,
			includeFiles = [];
		...
		if (includeSass01Folder01 !== null) {
			includeFiles.push(includeSass01Folder01);
		}

		if (includeSass01Folder02 !== null) {
			includeFiles.push(includeSass01Folder02);
		}

		if (includeSass01Folder03 !== null) {
			includeFiles.push(includeSass01Folder03);
		}

		if (includeSass02Folder01 !== null) {
			includeFiles.push(includeSass02Folder01);
		}

		if (includeSass02Folder02 !== null) {
			includeFiles.push(includeSass02Folder02);
		}

		if (includeSass02Folder03 !== null) {
			includeFiles.push(includeSass02Folder03);
		}

		if (includeSass03Folder01 !== null) {
			includeFiles.push(includeSass03Folder01);
		}

		if (includeSass03Folder02 !== null) {
			includeFiles.push(includeSass03Folder02);
		}

		if (includeSass03Folder03 !== null) {
			includeFiles.push(includeSass03Folder03);
		}
	...
	this.focus = function() {
		var wenum = Components.classes["@mozilla.org/embedcomp/window-watcher;1"]
			...
			.getWindowEnumerator();
		var index = 1;
		var windowName = "sass-filescope-prefs";
